...
import com.openuc.cloud.sdk.message.ReplyRestartCmdMessage;
...
public class ReplyRestartCmdDecoder implements CmdDecoder {
    ...
    public CmdMessage process(ApplicationMessage message) {
        ...
        ReplyRestartCmdMessage replyRestartCmdMessage = new ReplyRestartCmdMessage(getCmdCode(), pileCode);
        replyRestartCmdMessage.setResult(result);

        return replyRestartCmdMessage;
